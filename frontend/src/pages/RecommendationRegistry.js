...
const RecommendationRegistry = ({ study, onBack, onNavigate, theme, toggleTheme }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const colRes = await fetch(`http://localhost:5000/api/columns/${study._id}/recommendations`, {
